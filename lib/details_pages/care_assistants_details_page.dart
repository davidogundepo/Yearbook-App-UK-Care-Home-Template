...
String bestMomentTitle = "My best moment so far in $careHomeName\n";
String worstMomentTitle = "My worst moment so far in $careHomeName\n";
String dobTitle = "My Date of Birth\n";
String regionOfOriginTitle = "My Region of Origin\n";
String countryTitle = "My Nationality\n";
String qualificationTitle = "My Qualifications\n";
String staffPositionTitle = "My Occupation(s) at work\n";
String yearOfInceptionTitle = "Inception with $careHomeName\n";
...
Color backgroundColor = Color.fromRGBO(40, 53, 103, 1.0);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(40, 53, 103, 1.0);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(40, 53, 103, 1.0);
Color shapeDecorationColorTwo = Color.fromRGBO(40, 53, 103, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(40, 53, 103, 1.0);
Color shapeDecorationIconColor = Color.fromRGBO(40, 53, 103, 1.0);
...
Color iconTextColorTwo = Color.fromRGBO(40, 53, 103, 1.0);
Color buttonColor = Color.fromRGBO(40, 53, 103, 1.0);
Color textColor = Color.fromRGBO(40, 53, 103, 1.0);
...
CareAssistantsNotifier careAssistantsNotifier;
...
class CareAssistantsDetailsPage extends StatefulWidget {
  CareAssistantsDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _CareAssistantsDetailsPage createState() => _CareAssistantsDetailsPage();
}

class _CareAssistantsDetailsPage extends State<CareAssistantsDetailsPage> {
  ...
  Widget build(BuildContext context) {
    careAssistantsNotifier = Provider.of<CareAssistantsNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: careAssistantsNotifier.currentCareAssistants.image,
                        fit: BoxFit.cover,
                  ...
                  message: careAssistantsNotifier.currentCareAssistants.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              careAssistantsNotifier.currentCareAssistants.name.toUpperCase(),
  ...
  initState() {
    ...
    CareAssistantsNotifier careAssistantsNotifier = Provider.of<CareAssistantsNotifier>(context, listen: false);

    _autoBio = careAssistantsNotifier.currentCareAssistants.autoBio;
    _bestMoment = careAssistantsNotifier.currentCareAssistants.bestMoment;
    _dob = careAssistantsNotifier.currentCareAssistants.dob;
    _qualification = careAssistantsNotifier.currentCareAssistants.qualification;
    _staffPosition = careAssistantsNotifier.currentCareAssistants.staffPosition;
    _yearOfInception = careAssistantsNotifier.currentCareAssistants.yearOfInception;
    _regionFrom = careAssistantsNotifier.currentCareAssistants.regionOfOrigin;
    _email = careAssistantsNotifier.currentCareAssistants.email;
    _facebook = careAssistantsNotifier.currentCareAssistants.facebook;
    _hobbies = careAssistantsNotifier.currentCareAssistants.hobbies;
    _instagram = careAssistantsNotifier.currentCareAssistants.instagram;
    _name = careAssistantsNotifier.currentCareAssistants.name;
    _philosophy = careAssistantsNotifier.currentCareAssistants.philosophy;
    _phone = careAssistantsNotifier.currentCareAssistants.phone;
    _country = careAssistantsNotifier.currentCareAssistants.nationality;
    _twitter = careAssistantsNotifier.currentCareAssistants.twitter;
    _snapchat = careAssistantsNotifier.currentCareAssistants.snapchat;
    _tikTok = careAssistantsNotifier.currentCareAssistants.tikTok;
    _worstMoment = careAssistantsNotifier.currentCareAssistants.worstMoment;
