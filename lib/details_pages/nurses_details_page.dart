...
Color shapeDecorationColor = Color.fromRGBO(5, 118, 109, 1.0);
Color shapeDecorationColorTwo = Colors.white;
Color shapeDecorationColorThree = Color.fromRGBO(5, 118, 109, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(5, 118, 109, 1.0);
Color shapeDecorationIconColor = Color.fromRGBO(5, 118, 109, 1.0);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(5, 118, 109, 1.0);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(5, 118, 109, 1.0);
Color iconTextColor = Colors.white;
Color iconTextColorTwo = Color.fromRGBO(5, 118, 109, 1.0);
Color buttonColor = Color.fromRGBO(5, 118, 109, 1.0);
Color textColor = Color.fromRGBO(5, 118, 109, 1.0);
...
class _SubPageState extends State<SubPage> {
  ...
  Widget build(BuildContext context) {
    nursesNotifier = Provider.of<NursesNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: nursesNotifier.currentNurses.image,
                        fit: BoxFit.cover,
                  ...
                  message: nursesNotifier.currentNurses.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              nursesNotifier.currentNurses.name.toUpperCase(),
  ...
  initState() {
    ...
    _autoBio = nursesNotifier.currentNurses.autoBio;
    _bestMoment = nursesNotifier.currentNurses.bestMoment;
    _dob = nursesNotifier.currentNurses.dob;
    _qualification = nursesNotifier.currentNurses.qualification;
    _staffPosition = nursesNotifier.currentNurses.staffPosition;
    _yearOfInception = nursesNotifier.currentNurses.yearOfInception;
    _regionFrom = nursesNotifier.currentNurses.regionOfOrigin;
    _email = nursesNotifier.currentNurses.email;
    _facebook = nursesNotifier.currentNurses.facebook;
    _hobbies = nursesNotifier.currentNurses.hobbies;
    _instagram = nursesNotifier.currentNurses.instagram;
    _name = nursesNotifier.currentNurses.name;
    _philosophy = nursesNotifier.currentNurses.philosophy;
    _phone = nursesNotifier.currentNurses.phone;
    _country = nursesNotifier.currentNurses.nationality;
    _twitter = nursesNotifier.currentNurses.twitter;
    _snapchat = nursesNotifier.currentNurses.snapchat;
    _tikTok = nursesNotifier.currentNurses.tikTok;
    _worstMoment = nursesNotifier.currentNurses.worstMoment;
