...
class MyCareAssistantsSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyCareAssistantsSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((careAssistants) => careAssistants.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((careAssistants) => careAssistants.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          careAssistantsNotifier.currentCareAssistants = search[position];
