...
Color dialogBackgroundColor = Color.fromRGBO(31, 29, 54, 1);
Color borderColor = Colors.black;
Color textHighlightColor = Color.fromRGBO(152, 160, 188, 1.0);

var queryTech;

class MyNCStaffSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyNCStaffSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((nCStaff) => nCStaff.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((nCStaff) => nCStaff.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          nCStaffNotifier.currentNCStaff = search[position];
