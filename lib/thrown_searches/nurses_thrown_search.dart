...
Color cardBackgroundColor = Color.fromRGBO(94, 148, 138, 1.0);
...
Color textHighlightColor = Color.fromRGBO(94, 148, 138, 1.0);

var queryTech;

class MyNursesSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyNursesSearch({@required this.all});
  ...
  Future navigateToNursesDetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((nurses) => nurses.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((nurses) => nurses.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          nursesNotifier.currentNurses = search[position];
                          navigateToNursesDetailsPage(context);
                        },
