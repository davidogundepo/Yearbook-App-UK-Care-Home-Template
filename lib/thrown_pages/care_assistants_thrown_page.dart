...
import '../thrown_searches/care_assistants_thrown_search.dart';
import '../api/care_assistants_api.dart';
import '../bloc_navigation_bloc/navigation_bloc.dart';
import '../notifier/care_assistants_notifier.dart';
import 'package:provider/provider.dart';
import '../details_pages/care_assistants_details_page.dart';
...
String thrownName = "Care Assistants";
...
String appOverviewSharedPreferencesContentOne = "This Yearbook App was developed for $careHomeName, a Secondary School in $postcode, $city, $stateName. $countryName.\n";
...
String imgAsset = "assets/images/landing_1.jpeg";
...
Color modalBackgroundColor = Color.fromRGBO(40, 53, 103, 1.0);
Color materialBackgroundColor = Colors.transparent;
Color cardBackgroundColor = Color.fromRGBO(85, 114, 128, 1.0);
Color splashColor = Color.fromRGBO(40, 53, 103, 1.0);
...
Color dialogBackgroundColor = Color.fromRGBO(40, 53, 103, 1.0);
Color borderColor = Colors.black;
Color paintColor = Colors.indigo;
Color paintColorTwo = Colors.indigoAccent;


class MyCareAssistantsPage extends StatefulWidget with NavigationStates{
  MyCareAssistantsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _MyCareAssistantsPage createState() => _MyCareAssistantsPage();
}

class _MyCareAssistantsPage extends State<MyCareAssistantsPage> {
  ...
  Widget _buildProductItem(BuildContext context, int index) {
    CareAssistantsNotifier careAssistantsNotifier = Provider.of<CareAssistantsNotifier>(context);
    return Padding(
      ...
      child: Container(
        ...
        child: Material(
          ...
          splashColor: splashColor,
            onTap: () {
              careAssistantsNotifier.currentCareAssistants = careAssistantsNotifier.careAssistantsList[index];
              navigateToCareAssistantsDetailsPage(context);
            },
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            ...
                            image: CachedNetworkImageProvider(
                              careAssistantsNotifier.careAssistantsList[index].image
                          ),
                          fit: BoxFit.cover
                        )
                      ),
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                Text(
                                    careAssistantsNotifier.careAssistantsList[index].name,
                          ...
                          //   child: Text(
                          //       careAssistantsNotifier.careAssistantsList[index].twitter,
  ...
  Future navigateToCareAssistantsDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => CareAssistantsDetailsPage()));
  }
  ...
  void initState() {
    ...
    getCareAssistants(careAssistantsNotifier);
                ...
                SliverAppBar(
                  actions: <Widget>[
                    ...
                    IconButton(
                      ...
                      onPressed: careAssistantsNotifier.careAssistantsList == null
                          ? null
                          : (){
                        showSearch(
                          context: context,
                          delegate: MyCareAssistantsSearch(all: careAssistantsNotifier.careAssistantsList),
                        );
                      },
                      tooltip: "Search",
                    ),
            ...
            body: Padding(
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: careAssistantsNotifier.careAssistantsList.length,
